...
void vector_save(struct vector* vector)
{
  ...
  // We are not allowed to modify the saves so set it to NULL
  // wehn we push it to the save stack.
  tmp_vec.saves = NULL;
