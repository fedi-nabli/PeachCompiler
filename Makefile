OBJECTS = ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/lex_process.o ./build/token.o ./build/parser.o ./build/node.o ./build/scope.o ./build/symresolver.o ./build/codegen.o ./build/stackframe.o ./build/fixup.o ./build/array.o ./build/expressionable.o ./build/datatype.o ./build/helper.o ./build/helpers/buffer.o ./build/helpers/vector.o
INCLUDES = -I./
